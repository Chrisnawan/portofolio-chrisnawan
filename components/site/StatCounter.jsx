...
export default function StatCounter({ value }) {
  ...
  useEffect(() => {
    ...
    // Elemen di Hero sudah "intersecting" sejak awal (di atas lipatan),
    // tapi masih tertutup layar intro — tunggu intro-lock hilang dulu
    // supaya animasinya kelihatan, bukan selesai duluan di baliknya.
    function waitIntroThenCount() {
